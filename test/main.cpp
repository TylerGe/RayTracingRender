...
int main(int argc, char *argv[])
{
	...
	int samples = 2000;            // Default samples per pixel
    ...
    scene.add(dynamic_cast<Object*>(new Sphere(Vector3d(378.0f, 273.0f, 273.0f),
        90, Material(SPEC, Vector3d(0.01, 0.212, 0.286)))));
...
//        Material(DIFF, { 1.0f, 0.0f, 0.0f }))));
    scene.add( dynamic_cast<Object*>(new Mesh(Vector3d(158.0f, 273.0f, 273.0f), "teddy.obj", Material(DIFF, { 0.803f, 0.702f, 0.502f }))) );
